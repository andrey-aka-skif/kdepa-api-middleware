...
------------ | ------------- | ------------- | -------------
*KdepaApiMiddleware.StationsApi* | [**stationsDefaultGet**](docs/StationsApi.md#stationsDefaultGet) | **GET** /Stations/default | Получить Станцию по умолчанию
*KdepaApiMiddleware.StationsApi* | [**stationsGet**](docs/StationsApi.md#stationsGet) | **GET** /Stations | Получить пагинированный список Станций
...
## Documentation for Models
 ...
 - [KdepaApiMiddleware.CreateStationDto](docs/CreateStationDto.md)
 - [KdepaApiMiddleware.SortDto](docs/SortDto.md)
 - [KdepaApiMiddleware.StationDto](docs/StationDto.md)
 - [KdepaApiMiddleware.StationDtoPaginatedItemsDto](docs/StationDtoPaginatedItemsDto.md)
