...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.FactoryDtoFactoriesQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('FactoryDtoFactoriesQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of FactoryDtoFactoriesQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test FactoryDtoFactoriesQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.FactoryDtoFactoriesQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.FactoryDtoFactoriesQueryFilterDtoPagedItemsDto);
    });
