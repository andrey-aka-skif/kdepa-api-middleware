...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.ChartPoint();
  });
  ...
  describe('ChartPoint', function() {
    it('should create an instance of ChartPoint', function() {
      // uncomment below and update the code to test ChartPoint
      //var instance = new KdepaApi.ChartPoint();
      //expect(instance).to.be.a(KdepaApi.ChartPoint);
    });
