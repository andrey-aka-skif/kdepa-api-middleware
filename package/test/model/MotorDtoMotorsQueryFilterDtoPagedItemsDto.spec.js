...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.MotorDtoMotorsQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('MotorDtoMotorsQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of MotorDtoMotorsQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test MotorDtoMotorsQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.MotorDtoMotorsQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.MotorDtoMotorsQueryFilterDtoPagedItemsDto);
    });
