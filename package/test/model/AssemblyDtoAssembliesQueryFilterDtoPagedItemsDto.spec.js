...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.AssemblyDtoAssembliesQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('AssemblyDtoAssembliesQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of AssemblyDtoAssembliesQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test AssemblyDtoAssembliesQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.AssemblyDtoAssembliesQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.AssemblyDtoAssembliesQueryFilterDtoPagedItemsDto);
    });
