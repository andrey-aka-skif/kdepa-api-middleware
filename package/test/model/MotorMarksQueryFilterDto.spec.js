...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.MotorMarksQueryFilterDto();
  });
  ...
  describe('MotorMarksQueryFilterDto', function() {
    it('should create an instance of MotorMarksQueryFilterDto', function() {
      // uncomment below and update the code to test MotorMarksQueryFilterDto
      //var instance = new KdepaApi.MotorMarksQueryFilterDto();
      //expect(instance).to.be.a(KdepaApi.MotorMarksQueryFilterDto);
    });
