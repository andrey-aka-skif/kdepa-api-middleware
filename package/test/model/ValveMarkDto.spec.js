...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.ValveMarkDto();
  });
  ...
  describe('ValveMarkDto', function() {
    it('should create an instance of ValveMarkDto', function() {
      // uncomment below and update the code to test ValveMarkDto
      //var instance = new KdepaApi.ValveMarkDto();
      //expect(instance).to.be.a(KdepaApi.ValveMarkDto);
    });
