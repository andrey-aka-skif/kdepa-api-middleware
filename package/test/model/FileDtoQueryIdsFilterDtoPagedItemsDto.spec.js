...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.FileDtoQueryIdsFilterDtoPagedItemsDto();
  });
  ...
  describe('FileDtoQueryIdsFilterDtoPagedItemsDto', function() {
    it('should create an instance of FileDtoQueryIdsFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test FileDtoQueryIdsFilterDtoPagedItemsDto
      //var instance = new KdepaApi.FileDtoQueryIdsFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.FileDtoQueryIdsFilterDtoPagedItemsDto);
    });
