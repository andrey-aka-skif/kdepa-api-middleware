...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.DriveDtoDrivesQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('DriveDtoDrivesQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of DriveDtoDrivesQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test DriveDtoDrivesQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.DriveDtoDrivesQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.DriveDtoDrivesQueryFilterDtoPagedItemsDto);
    });
