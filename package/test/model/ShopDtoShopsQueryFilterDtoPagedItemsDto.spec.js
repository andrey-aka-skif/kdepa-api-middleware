...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.ShopDtoShopsQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('ShopDtoShopsQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of ShopDtoShopsQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test ShopDtoShopsQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.ShopDtoShopsQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.ShopDtoShopsQueryFilterDtoPagedItemsDto);
    });
