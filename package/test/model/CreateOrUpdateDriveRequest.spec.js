...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.CreateOrUpdateDriveRequest();
  });
  ...
  describe('CreateOrUpdateDriveRequest', function() {
    it('should create an instance of CreateOrUpdateDriveRequest', function() {
      // uncomment below and update the code to test CreateOrUpdateDriveRequest
      //var instance = new KdepaApi.CreateOrUpdateDriveRequest();
      //expect(instance).to.be.a(KdepaApi.CreateOrUpdateDriveRequest);
    });
