...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.DriveDto();
  });
  ...
  describe('DriveDto', function() {
    it('should create an instance of DriveDto', function() {
      // uncomment below and update the code to test DriveDto
      //var instance = new KdepaApi.DriveDto();
      //expect(instance).to.be.a(KdepaApi.DriveDto);
    });
