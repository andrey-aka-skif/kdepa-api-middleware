...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.SummaryFullDto();
  });
  ...
  describe('SummaryFullDto', function() {
    it('should create an instance of SummaryFullDto', function() {
      // uncomment below and update the code to test SummaryFullDto
      //var instance = new KdepaApi.SummaryFullDto();
      //expect(instance).to.be.a(KdepaApi.SummaryFullDto);
    });
