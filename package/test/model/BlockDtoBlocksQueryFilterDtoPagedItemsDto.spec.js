...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.BlockDtoBlocksQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('BlockDtoBlocksQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of BlockDtoBlocksQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test BlockDtoBlocksQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.BlockDtoBlocksQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.BlockDtoBlocksQueryFilterDtoPagedItemsDto);
    });
