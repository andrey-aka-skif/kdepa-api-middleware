...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.CabinetDtoCabinetsQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('CabinetDtoCabinetsQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of CabinetDtoCabinetsQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test CabinetDtoCabinetsQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.CabinetDtoCabinetsQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.CabinetDtoCabinetsQueryFilterDtoPagedItemsDto);
    });
