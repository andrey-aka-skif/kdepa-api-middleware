...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.SystemsQueryFilterDto();
  });
  ...
  describe('SystemsQueryFilterDto', function() {
    it('should create an instance of SystemsQueryFilterDto', function() {
      // uncomment below and update the code to test SystemsQueryFilterDto
      //var instance = new KdepaApi.SystemsQueryFilterDto();
      //expect(instance).to.be.a(KdepaApi.SystemsQueryFilterDto);
    });
