...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.DiagnosticDto();
  });
  ...
  describe('DiagnosticDto', function() {
    it('should create an instance of DiagnosticDto', function() {
      // uncomment below and update the code to test DiagnosticDto
      //var instance = new KdepaApi.DiagnosticDto();
      //expect(instance).to.be.a(KdepaApi.DiagnosticDto);
    });
