...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.ValveDtoValvesQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('ValveDtoValvesQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of ValveDtoValvesQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test ValveDtoValvesQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.ValveDtoValvesQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.ValveDtoValvesQueryFilterDtoPagedItemsDto);
    });
