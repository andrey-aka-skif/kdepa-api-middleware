...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.StationSystemDtoSystemsQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('StationSystemDtoSystemsQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of StationSystemDtoSystemsQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test StationSystemDtoSystemsQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.StationSystemDtoSystemsQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.StationSystemDtoSystemsQueryFilterDtoPagedItemsDto);
    });
