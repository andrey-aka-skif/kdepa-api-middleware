...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.CreateStationRequest();
  });
  ...
  describe('CreateStationRequest', function() {
    it('should create an instance of CreateStationRequest', function() {
      // uncomment below and update the code to test CreateStationRequest
      //var instance = new KdepaApi.CreateStationRequest();
      //expect(instance).to.be.a(KdepaApi.CreateStationRequest);
    });
