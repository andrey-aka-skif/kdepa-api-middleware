...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.ValveMarksQueryFilterDto();
  });
  ...
  describe('ValveMarksQueryFilterDto', function() {
    it('should create an instance of ValveMarksQueryFilterDto', function() {
      // uncomment below and update the code to test ValveMarksQueryFilterDto
      //var instance = new KdepaApi.ValveMarksQueryFilterDto();
      //expect(instance).to.be.a(KdepaApi.ValveMarksQueryFilterDto);
    });
