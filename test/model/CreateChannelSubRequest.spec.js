...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.CreateChannelSubRequest();
  });
  ...
  describe('CreateChannelSubRequest', function() {
    it('should create an instance of CreateChannelSubRequest', function() {
      // uncomment below and update the code to test CreateChannelSubRequest
      //var instance = new KdepaApi.CreateChannelSubRequest();
      //expect(instance).to.be.a(KdepaApi.CreateChannelSubRequest);
    });
