...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.SingleParamRowDto();
  });
  ...
  describe('SingleParamRowDto', function() {
    it('should create an instance of SingleParamRowDto', function() {
      // uncomment below and update the code to test SingleParamRowDto
      //var instance = new KdepaApi.SingleParamRowDto();
      //expect(instance).to.be.a(KdepaApi.SingleParamRowDto);
    });
