...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.ValvesQueryFilterDto();
  });
  ...
  describe('ValvesQueryFilterDto', function() {
    it('should create an instance of ValvesQueryFilterDto', function() {
      // uncomment below and update the code to test ValvesQueryFilterDto
      //var instance = new KdepaApi.ValvesQueryFilterDto();
      //expect(instance).to.be.a(KdepaApi.ValvesQueryFilterDto);
    });
