...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.ValveMarkExtendedDto();
  });
  ...
  describe('ValveMarkExtendedDto', function() {
    it('should create an instance of ValveMarkExtendedDto', function() {
      // uncomment below and update the code to test ValveMarkExtendedDto
      //var instance = new KdepaApi.ValveMarkExtendedDto();
      //expect(instance).to.be.a(KdepaApi.ValveMarkExtendedDto);
    });
    ...
    it('should have the property seismicCategories (base name: "seismicCategories")', function() {
      // uncomment below and update the code to test the property seismicCategories
      //var instance = new KdepaApi.ValveMarkExtendedDto();
      //expect(instance).to.be();
    });
    ...
    it('should have the property usingClass (base name: "usingClass")', function() {
      // uncomment below and update the code to test the property usingClass
      //var instance = new KdepaApi.ValveMarkExtendedDto();
      //expect(instance).to.be();
    });

    it('should have the property usingClasses (base name: "usingClasses")', function() {
      // uncomment below and update the code to test the property usingClasses
      //var instance = new KdepaApi.ValveMarkExtendedDto();
      //expect(instance).to.be();
    });
