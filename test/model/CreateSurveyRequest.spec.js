...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.CreateSurveyRequest();
  });
  ...
  describe('CreateSurveyRequest', function() {
    it('should create an instance of CreateSurveyRequest', function() {
      // uncomment below and update the code to test CreateSurveyRequest
      //var instance = new KdepaApi.CreateSurveyRequest();
      //expect(instance).to.be.a(KdepaApi.CreateSurveyRequest);
    });
