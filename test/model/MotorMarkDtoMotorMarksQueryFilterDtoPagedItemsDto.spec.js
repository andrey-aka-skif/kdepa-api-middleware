...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.MotorMarkDtoMotorMarksQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('MotorMarkDtoMotorMarksQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of MotorMarkDtoMotorMarksQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test MotorMarkDtoMotorMarksQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.MotorMarkDtoMotorMarksQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.MotorMarkDtoMotorMarksQueryFilterDtoPagedItemsDto);
    });
