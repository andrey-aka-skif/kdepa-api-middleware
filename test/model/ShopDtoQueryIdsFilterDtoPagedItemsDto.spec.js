...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.ShopDtoQueryIdsFilterDtoPagedItemsDto();
  });
  ...
  describe('ShopDtoQueryIdsFilterDtoPagedItemsDto', function() {
    it('should create an instance of ShopDtoQueryIdsFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test ShopDtoQueryIdsFilterDtoPagedItemsDto
      //var instance = new KdepaApi.ShopDtoQueryIdsFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.ShopDtoQueryIdsFilterDtoPagedItemsDto);
    });
