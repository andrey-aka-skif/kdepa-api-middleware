...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.ValveMarkDtoValveMarksQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('ValveMarkDtoValveMarksQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of ValveMarkDtoValveMarksQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test ValveMarkDtoValveMarksQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.ValveMarkDtoValveMarksQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.ValveMarkDtoValveMarksQueryFilterDtoPagedItemsDto);
    });
