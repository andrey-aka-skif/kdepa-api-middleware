...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.ShopsQueryFilterDto();
  });
  ...
  describe('ShopsQueryFilterDto', function() {
    it('should create an instance of ShopsQueryFilterDto', function() {
      // uncomment below and update the code to test ShopsQueryFilterDto
      //var instance = new KdepaApi.ShopsQueryFilterDto();
      //expect(instance).to.be.a(KdepaApi.ShopsQueryFilterDto);
    });
