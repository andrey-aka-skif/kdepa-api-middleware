...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.RegulatoryDocumentDto();
  });
  ...
  describe('RegulatoryDocumentDto', function() {
    it('should create an instance of RegulatoryDocumentDto', function() {
      // uncomment below and update the code to test RegulatoryDocumentDto
      //var instance = new KdepaApi.RegulatoryDocumentDto();
      //expect(instance).to.be.a(KdepaApi.RegulatoryDocumentDto);
    });
