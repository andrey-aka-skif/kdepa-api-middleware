...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KdepaApi.DriveMarkDtoDriveMarksQueryFilterDtoPagedItemsDto();
  });
  ...
  describe('DriveMarkDtoDriveMarksQueryFilterDtoPagedItemsDto', function() {
    it('should create an instance of DriveMarkDtoDriveMarksQueryFilterDtoPagedItemsDto', function() {
      // uncomment below and update the code to test DriveMarkDtoDriveMarksQueryFilterDtoPagedItemsDto
      //var instance = new KdepaApi.DriveMarkDtoDriveMarksQueryFilterDtoPagedItemsDto();
      //expect(instance).to.be.a(KdepaApi.DriveMarkDtoDriveMarksQueryFilterDtoPagedItemsDto);
    });
